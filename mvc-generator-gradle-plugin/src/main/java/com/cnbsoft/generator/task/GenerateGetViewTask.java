...
public abstract class GenerateGetViewTask extends MvcGeneratorBaseTask {
    @Override
    protected void executeForTable(String tableName, GeneratorConfig config,
        ...
        new ViewCodeGenerator(config, inspector, engine).generate(tableName, ViewCodeGenerator.ViewType.GET);
    }
}
